...
TLegend* get_legend(int corner=1, int entries=4, double yscale=1.0, double xscale=1.0, bool pull=false) {
	...
	else if (corner == 2) leg = new TLegend(0.59*xscale, 0.35+yadjust, 0.80, 0.35+height+yadjust);			// 2: Bottom-right
	else if (corner == 3) leg = new TLegend(0.19, 0.35+yadjust, 0.50*xscale, 0.35+height+yadjust);			// 3: Bottom-left
